...
bool LoadTextureFromMemory(const unsigned char* image_data, int image_size, ID3D11ShaderResourceView** out_srv, int* out_w, int* out_h) {
    int image_width = 0;
    int image_height = 0;
    unsigned char* image_pixels = stbi_load_from_memory(image_data, image_size, &image_width, &image_height, NULL, 4);
    if (image_pixels == NULL) return false;
    *out_w = image_width;
    *out_h = image_height;
